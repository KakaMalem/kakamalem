...
CREATE UNIQUE INDEX "variant_options_tenant_name_idx" ON "variant_options" USING btree ("tenant_id","name");ALTER TYPE "public"."order_status" ADD VALUE 'refunded';--> statement-breakpoint
...
CREATE UNIQUE INDEX "variant_option_values_tenant_option_value_idx" ON "variant_option_values" USING btree ("tenant_id","option_id","value");CREATE TABLE "product_variant_images" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
	"variant_id" uuid NOT NULL,
	"media_id" uuid NOT NULL,
